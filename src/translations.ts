...
export const content = {
  en: {
    ...
    home: {
      title: 'SYSTEM INIT',
      meta: '[SEC-01] // ROOT',
      p1: 'Welcome to the construction site.',
      p2: 'I’m Akmal from Tashkent. This website is both the tool and the result. Every week I push new updates to track my learning, document my journey, and build products in public. The UI you see today might be completely different tomorrow. The system tracks my growth, and in return, I upgrade the system.',
      p3: 'The goal is honest documentation. Step by step. Commit by commit.',
    ...
    console: {
      ...
      cmd_background: 'PAST EXPERIENCE // PHYSICAL PRODUCTS:\n\n[Placeholder Product]: Brief description of what it was and what you learned.',
  ...
  ru: {
    ...
    home: {
      ...
      meta: '[SEC-01] // ROOT',
      p1: 'Добро пожаловать на стройплощадку.',
      p2: 'Я Акмаль из Ташкента. Этот проект — одновременно мой инструмент и мой результат. Каждую неделю я заливаю сюда обновления: фиксирую свои знания и собираю продукты на публике. Интерфейс, который вы видите сегодня, завтра может полностью поменяться. Система отслеживает мой рост, а я взамен прокачиваю систему.',
      p3: 'Цель — честная документация. Шаг за шагом. Коммит за коммитом.',
    ...
    console: {
      ...
      cmd_background: 'ПРОШЛЫЙ ОПЫТ // ФИЗИЧЕСКИЕ ПРОДУКТЫ:\n\n[Placeholder Product]: Кратко опишите продукт и чему он научил.',
