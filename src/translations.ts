...
export const content = {
  en: {
    ...
    history: {
      ...
      items: [
        { id: 'v0.10', date: '2026-04-15', title: 'Stealth Auth & RBAC Foundation', desc: 'Implemented a hidden authentication layer via the terminal ("godmode" command). The system now distinguishes between public visitors and the admin, laying the groundwork for cloud data migration.', status: 'ACTIVE' },
  ...
  ru: {
    ...
    history: {
      ...
      meta: '[SEC-06] // PRODUCT CHANGELOG',
      items: [
        { id: 'v0.10', date: '2026-04-15', title: 'Скрытая авторизация и фундамент RBAC', desc: 'Внедрен скрытый слой авторизации через терминал (команда "godmode"). Система теперь различает публичных посетителей и администратора, подготавливая почву для миграции данных в облако.', status: 'АКТИВНО' },
